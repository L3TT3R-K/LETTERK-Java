...
class PhanSo {
    ...
    public boolean nhapPhanSo(Scanner sc) {
        System.out.print("Nhap tu so: ");
        if (!sc.hasNextInt()) {
            System.out.println("Tu so khong hop le. Vui long nhap so nguyen.");
        ...
        if (!sc.hasNextInt()) {
            System.out.println("Mau so khong hop le. Vui long nhap so nguyen.");
            if (sc.hasNextLine()) sc.nextLine();
            return false;
        }
        this.mau = sc.nextInt();
...
public class bai3 {
    public static PhanSo[] nhapHaiPhanSo(Scanner sc) {
        PhanSo ps1 = new PhanSo();
        System.out.println("Nhap phan so thu nhat:");
        if (!ps1.nhapPhanSo(sc)) {
            return null;
        }
        PhanSo ps2 = new PhanSo();  
        System.out.println("Nhap phan so thu hai:");
        if (!ps2.nhapPhanSo(sc)) {
            return null;
        }
        return new PhanSo[] { ps1, ps2 };
    }

    public static void tinhVaInKetQua(PhanSo ps1, PhanSo ps2) {
    ...
    public static void run(Scanner sc) {
        PhanSo[] danhSach = nhapHaiPhanSo(sc);
        if (danhSach == null) {
            return;
        }
        tinhVaInKetQua(danhSach[0], danhSach[1]);
    }
